            ...
            child: Container(
              ...
              child: GridView.count(
                ...
                children: [
                  ...
                  _buildCategoryItem(context,'Transport', Icons.directions_bus, Colors.blue,'/food'),
                  _buildCategoryItem(context,'Medicine', Icons.medical_services_outlined, Colors.blue,'/food'),
                  _buildCategoryItem(context,'Groceries', Icons.shopping_basket_outlined, Colors.blue,'/food'),
                  _buildCategoryItem(context,'Rent', Icons.vpn_key_outlined, Colors.blue,'/food'),
                  _buildCategoryItem(context,'Gifts', Icons.card_giftcard, Colors.blue,'/food'),
                  _buildCategoryItem(context,'Savings', Icons.savings_outlined, Colors.blue,'/food'),
                  _buildCategoryItem(context,'Entertainment', Icons.confirmation_number_outlined, Colors.blue,'/food'),
