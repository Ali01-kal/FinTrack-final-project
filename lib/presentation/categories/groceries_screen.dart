...
class GroceriesScreen extends StatelessWidget {
                ...
                children: [
                  ListView(
                    ...
                    children: [
                      ...
                      _buildGroceryItem('Pantry', '18:27 - March 10', '-\$53.59'),
                      _buildGroceryItem('Snacks', '15:00 - March 01', '-\$35.03'),
                      
                      const SizedBox(height: 20),
                      
                      _buildSectionHeader('February'),
                      _buildGroceryItem('Canned Food', '10:47 - February 30', '-\$11.82'),
                      _buildGroceryItem('Veggies', '7:30 - February 20', '-\$14.79'),
                      _buildGroceryItem('Groceries', '18:50 - February 01', '-\$175.35'),
  ...
  Widget _buildGroceryItem(String title, String time, String amount) {
    return Container(
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.shopping_basket_outlined, color: Color(0xFF42A5F5)),
          ),
  ...
  // Ортақ функциялар (TransportScreen-дегідей қала береді)
