...
class GiftsScreen extends StatelessWidget {
                ...
                children: [
                  ListView(
                    ...
                    children: [
                      ...
                      _buildGiftItem('Perfume', '10:27 - April 28', '-\$30,00'),
                      _buildGiftItem('Make-Up', '16:28 - April 15', '-\$60,35'),
                      
                      const SizedBox(height: 20),
                      
                      _buildSectionHeader('March'),
                      _buildGiftItem('Teddy Bear', '8:30 - March 10', '-\$20,00'),
                      _buildGiftItem('Cooking Lessons', '14:24 - March 02', '-\$128,00'),
                      
                      const SizedBox(height: 20),
                      
                      _buildSectionHeader('February'),
                      _buildGiftItem('Toys For Dani', '11:15 - February 18', '-\$50,20'),
  ...
  Widget _buildGiftItem(String title, String time, String amount) {
    return Container(
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.card_giftcard, color: Color(0xFF42A5F5)),
          ),
