  ...
  Widget _buildCategoryRow() {
    ...
    return Row(
      ...
      children: ['General', 'Account', 'Services'].map((cat) => 
        Text(cat, style:  TextStyle(color: isDark ? Colors.white : Colors.black, fontWeight: FontWeight.w500))
      ).toList(),
    );
  }
  ...
  Widget _buildContactItem(IconData icon, String title) {
    return ListTile(
      leading: Container(
        ...
        decoration: BoxDecoration(color: Color(0xFF00D19E), shape: BoxShape.circle),
      ...
      onTap: () {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('$title is not configured yet')),
        );
      },
    );
  }
