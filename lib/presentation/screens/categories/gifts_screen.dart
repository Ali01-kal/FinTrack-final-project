  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Gifts', style: TextStyle(color: isDark ? Colors.white : const Color(0xFF1B3D3D), fontWeight: FontWeight.bold)),
        centerTitle: true,
          ...
          Expanded(
            child: Container(
              ...
              child: Stack(
                ...
                children: [
                  const CategoryTransactionsList(categoryId: 'gifts', icon: Icons.card_giftcard),
                  Positioned(
                    bottom: 20,
