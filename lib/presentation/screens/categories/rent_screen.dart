  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Rent', style: TextStyle(color: isDark ? Colors.white : const Color(0xFF1B3D3D), fontWeight: FontWeight.bold)),
        centerTitle: true,
          ...
          Expanded(
            child: Container(
              ...
              child: Stack(
                ...
                children: [
                  const CategoryTransactionsList(categoryId: 'rent', icon: Icons.vpn_key_outlined),
                  Positioned(
                    bottom: 20,
