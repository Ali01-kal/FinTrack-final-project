  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Groceries', style: TextStyle(color: isDark ? Colors.white : const Color(0xFF1B3D3D), fontWeight: FontWeight.bold)),
        centerTitle: true,
          ...
          Expanded(
            child: Container(
              ...
              child: Stack(
                ...
                children: [
                  const CategoryTransactionsList(categoryId: 'groceries', icon: Icons.shopping_basket_outlined),
                  Positioned(
                    bottom: 20,
